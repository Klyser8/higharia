...
public class FireBoltProjectile : ModProjectile, ILocalizedModType
{
    ...
    public override void AI()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            int fourConst = 4;
            int fireDust = Dust.NewDust(new Vector2(Projectile.position.X + (float)fourConst, Projectile.position.Y + (float)fourConst), Projectile.width - fourConst, Projectile.height - fourConst, DustID.InfernoFork, 0f, 0f, 100, default, 1.2f);
